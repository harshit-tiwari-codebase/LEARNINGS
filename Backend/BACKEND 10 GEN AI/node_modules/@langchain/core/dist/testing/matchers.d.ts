import { StreamMatchers, toHaveStreamOutput, toHaveStreamReasoning, toHaveStreamText, toHaveStreamToolCalls, toHaveStreamUsage } from "../../src/utils/testing/stream.js";
...
declare const toBeHumanMessage: (this: ExpectExtendThis, received: unknown, expected?: string | Record<string, unknown>) => ExpectationResult;
declare const toBeAIMessage: (this: ExpectExtendThis, received: unknown, expected?: string | Record<string, unknown>) => ExpectationResult;
declare const toBeSystemMessage: (this: ExpectExtendThis, received: unknown, expected?: string | Record<string, unknown>) => ExpectationResult;
declare const toBeToolMessage: (this: ExpectExtendThis, received: unknown, expected?: string | Record<string, unknown>) => ExpectationResult;
...
declare const langchainMatchers: {
  toHaveStreamText: typeof toHaveStreamText;
  toHaveStreamReasoning: typeof toHaveStreamReasoning;
  toHaveStreamToolCalls: typeof toHaveStreamToolCalls;
  toHaveStreamUsage: typeof toHaveStreamUsage;
  toHaveStreamOutput: typeof toHaveStreamOutput;
  toBeHumanMessage: (this: ExpectExtendThis, received: unknown, expected?: string | Record<string, unknown>) => ExpectationResult;
  toBeAIMessage: (this: ExpectExtendThis, received: unknown, expected?: string | Record<string, unknown>) => ExpectationResult;
  toBeSystemMessage: (this: ExpectExtendThis, received: unknown, expected?: string | Record<string, unknown>) => ExpectationResult;
  toBeToolMessage: (this: ExpectExtendThis, received: unknown, expected?: string | Record<string, unknown>) => ExpectationResult;
...
interface LangChainMatchers<R = unknown> extends StreamMatchers<R> {
