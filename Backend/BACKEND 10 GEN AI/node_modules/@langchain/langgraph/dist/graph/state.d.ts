...
import { TimeoutPolicy } from "../../src/pregel/utils/timeout.js";
import { Command, CommandInstance, END, INTERRUPT, Interrupt, START } from "../../src/constants.js";
import { SchemaMetaRegistry } from "../../src/graph/zod/meta.js";
import { RunnableLike, Runtime } from "../../src/pregel/runnable_types.js";
import { AnnotationRoot, SingleReducer, StateDefinition, StateType } from "../../src/graph/annotation.js";
import { CachePolicy, RetryPolicy } from "../../src/pregel/utils/index.js";
import { StreamTransformer } from "../../src/stream/types.js";
import { AnyStateSchema } from "../../src/state/schema.js";
import { ContextSchemaInit, ExtractStateType, ExtractUpdateType, StateDefinitionInit, StateGraphInit, StateGraphOptions, ToStateDefinition } from "../../src/graph/types.js";
import { AddNodeOptions, Branch, CompiledGraph, Graph, NodeErrorHandler, NodeSpec } from "../../src/graph/graph.js";
import { InferInterruptInputType, InferInterruptResumeType } from "../../src/interrupt.js";
import { InferWriterType } from "../../src/writer.js";
...
declare class CompiledStateGraph<S, U, N extends string = typeof START, I extends StateDefinitionInit = StateDefinition, O extends StateDefinitionInit = StateDefinition, C extends StateDefinitionInit = StateDefinition, NodeReturnType = unknown, InterruptType = unknown, WriterType = unknown, TStreamTransformers extends ReadonlyArray<() => StreamTransformer<any>> = []> extends CompiledGraph<N, S, U, ExtractStateType<C>, ExtractUpdateType<I, ExtractStateType<I>>, ExtractStateType<O>, NodeReturnType, CommandInstance<InferInterruptResumeType<InterruptType>, Prettify<U>, N>, InferWriterType<WriterType>, TStreamTransformers> {
  ...
  constructor({
    ...
    description?: string;
  } & ConstructorParameters<typeof CompiledGraph<N, S, U, ExtractStateType<C>, ExtractUpdateType<I, ExtractStateType<I>>, ExtractStateType<O>, NodeReturnType, CommandInstance<InferInterruptResumeType<InterruptType>, Prettify<U>, N>, InferWriterType<WriterType>, TStreamTransformers>>[0]);
