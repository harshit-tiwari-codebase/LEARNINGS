...
import { ZodV3Like, ZodV4Like } from "../../src/utils/types/zod.js";
...
import { ChatModelStream } from "../../src/language_models/stream.js";
...
declare abstract class BaseChatModel<CallOptions extends BaseChatModelCallOptions = BaseChatModelCallOptions, OutputMessageType extends BaseMessageChunk = AIMessageChunk> extends BaseLanguageModel<OutputMessageType, CallOptions> {
   ...
   */
  streamEvents(input: BaseLanguageModelInput, options: Partial<CallOptions> & {
    version: "v2";
   ...
   * ```
   */
  streamEvents(input: BaseLanguageModelInput, options?: Partial<CallOptions>): ChatModelStream;
  /**
